    ...
    return (
      <input
        ...
        className={cn(
          ...
          "[&:-webkit-autofill]:bg-white [&:-webkit-autofill]:text-foreground [&:-webkit-autofill:hover]:bg-white [&:-webkit-autofill:focus]:bg-white [&:-webkit-autofill:active]:bg-white",
          className
        )}
        ref={ref}
        {...props}
